...
(describe "Tic Tac Toe Board"
  ...
  (context "places a value into the tttb"
    (it "an X into top left corner"
      (should= [0 0 2 0 0 0 0 0 0] (tttb/place-value-into-tttb tttb/empty-board 2 2)))

    (it "an X and O in opposite corners"
      (should= [1 0 0 0 0 0 0 0 2] (-> tttb/empty-board (tttb/place-value-into-tttb 1 0) (tttb/place-value-into-tttb 2 8))))

    (it "a series of inputs"
      (should= mixed-board (-> tttb/empty-board
