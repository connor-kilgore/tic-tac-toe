...
var i_25207 = (0);
while(true){
if((i_25207 < arr.length)){
(arr[i_25207] = null);

var G__25208 = (i_25207 + (1));
i_25207 = G__25208;
continue;
} else {
}
...
var i_25217 = (self__.level + (1));
while(true){
if((i_25217 <= (new_level + (1)))){
(update[i_25217] = self__.header);
...
while(true){
if((i <= self__.level)){
var links_25219 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_25219[i]));
} else {
x__$2.forward.push((((i < links_25219.length))?(links_25219[i]):null));
}

if((i < links_25219.length)){
(links_25219[i] = x__$2);
} else {
links_25219.push(x__$2);
}
...
var i_25221 = (0);
while(true){
if((i_25221 <= self__.level)){
var links_25222 = (update[i_25221]).forward;
if((x__$1 === (((i_25221 < links_25222.length))?(links_25222[i_25221]):null))){
(links_25222[i_25221] = (x__$1.forward[i_25221]));

var G__25223 = (i_25221 + (1));
i_25221 = G__25223;
continue;
} else {
var G__25224 = (i_25221 + (1));
i_25221 = G__25224;
continue;
}
} else {
...
var G__25226 = nx;
var G__25227 = (level__$1 - (1));
x = G__25226;
level__$1 = G__25227;
continue;
} else {
var G__25228 = x;
var G__25229 = (level__$1 - (1));
x = G__25228;
level__$1 = G__25229;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__25231 = nx;
var G__25232 = (level__$1 - (1));
x = G__25231;
level__$1 = G__25232;
continue;
} else {
var G__25233 = x;
var G__25234 = (level__$1 - (1));
x = G__25233;
level__$1 = G__25234;
continue;
}
