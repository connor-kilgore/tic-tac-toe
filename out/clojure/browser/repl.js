...
var seq__2050_2054 = cljs.core.seq.call(null,clojure.browser.repl.print_queue);
var chunk__2051_2055 = null;
var count__2052_2056 = (0);
var i__2053_2057 = (0);
while(true){
if((i__2053_2057 < count__2052_2056)){
var str_2058 = cljs.core._nth.call(null,chunk__2051_2055,i__2053_2057);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_2058})));


var G__2059 = seq__2050_2054;
var G__2060 = chunk__2051_2055;
var G__2061 = count__2052_2056;
var G__2062 = (i__2053_2057 + (1));
seq__2050_2054 = G__2059;
chunk__2051_2055 = G__2060;
count__2052_2056 = G__2061;
i__2053_2057 = G__2062;
continue;
} else {
var temp__5753__auto___2063 = cljs.core.seq.call(null,seq__2050_2054);
if(temp__5753__auto___2063){
var seq__2050_2064__$1 = temp__5753__auto___2063;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__2050_2064__$1)){
var c__5568__auto___2065 = cljs.core.chunk_first.call(null,seq__2050_2064__$1);
var G__2066 = cljs.core.chunk_rest.call(null,seq__2050_2064__$1);
var G__2067 = c__5568__auto___2065;
var G__2068 = cljs.core.count.call(null,c__5568__auto___2065);
var G__2069 = (0);
seq__2050_2054 = G__2066;
chunk__2051_2055 = G__2067;
count__2052_2056 = G__2068;
i__2053_2057 = G__2069;
continue;
} else {
var str_2070 = cljs.core.first.call(null,seq__2050_2064__$1);
clojure.browser.net.transmit.call(null,conn,new cljs.core.Keyword(null,"print","print",1299562414),goog.json.serialize(({"repl": clojure.browser.repl._STAR_repl_STAR_, "str": str_2070})));


var G__2071 = cljs.core.next.call(null,seq__2050_2064__$1);
var G__2072 = null;
var G__2073 = (0);
var G__2074 = (0);
seq__2050_2054 = G__2071;
chunk__2051_2055 = G__2072;
count__2052_2056 = G__2073;
i__2053_2057 = G__2074;
continue;
}
} else {
}
...
var script__$1 = (function (){var G__2079 = script;
clojure.browser.repl.goog$module$goog$object.set.call(null,G__2079,"type","text/javascript");

clojure.browser.repl.goog$module$goog$object.set.call(null,G__2079,"onload",onload);

clojure.browser.repl.goog$module$goog$object.set.call(null,G__2079,"onreadystatechange",onload);

return G__2079;
})();
if((opt_sourceText == null)){
var G__2080 = script__$1;
clojure.browser.repl.goog$module$goog$object.set.call(null,G__2080,"src",src);

return G__2080;
} else {
var G__2081 = script__$1;
goog.dom.setTextContent(G__2081,opt_sourceText);
...
var path_2082 = goog.debugLoader_.getPathFromDeps_(src);
clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.debugLoader_.written_,path_2082);

clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.debugLoader_.written_,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_2082)].join(''));
} else {
var path_2083 = clojure.browser.repl.goog$module$goog$object.get.call(null,goog.dependencies_.nameToPath,src);
clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.dependencies_.visited,path_2083);

clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.dependencies_.written,path_2083);

clojure.browser.repl.goog$module$goog$object.remove.call(null,goog.dependencies_.written,[cljs.core.str.cljs$core$IFn$_invoke$arity$1(goog.basePath),cljs.core.str.cljs$core$IFn$_invoke$arity$1(path_2083)].join(''));
}
} else {
}
...
return clojure.browser.net.transmit.call(null,repl_connection,new cljs.core.Keyword(null,"send-result","send-result",35388249),goog.json.serialize(({"repl": repl, "result": (function (){var _STAR_repl_STAR__orig_val__2084 = clojure.browser.repl._STAR_repl_STAR_;
var _STAR_repl_STAR__temp_val__2085 = repl;
(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__temp_val__2085);

try{return clojure.browser.repl.evaluate_javascript.call(null,repl_connection,form);
}finally {(clojure.browser.repl._STAR_repl_STAR_ = _STAR_repl_STAR__orig_val__2084);
}})()})));
}));
